...
class InferenceModel:
    ...
    def __init__(self, params: dict, cnn_model: nn.Module, flow_model: nn.Module, data_dirs: list, device: str = 'cpu') -> None:
        ...
        unsorted_data = PowerSpectrumDataset(data_dirs, exclude_unfinished_reionization=True, exclude_early_reionization=False)
...
if __name__ == "__main__":
    ...
    model_dir = '/remote/gpu01a/pietschke/EoRFlow/output/full_EoR_highZ_noise_8_512'
