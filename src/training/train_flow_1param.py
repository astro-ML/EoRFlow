...
output_dir = '/remote/gpu01a/pietschke/EoRFlow/output/SKA_flow_2param/flow_10_512'
...
model_params = {
    'flow': {
        'n_dim': 2,         # Inferring 3 neutral fraction parameters (for 3 redshifts)
        'n_blocks': 10,
        'n_nodes': 512,
        'cond_dims': 200,    # Condition is the flattened 2DPS of size (3 * 10 * 10); double-check if 303 is intended vs 300
