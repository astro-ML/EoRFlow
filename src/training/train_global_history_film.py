...
from cnn import CNN2D_film as CNN  # Assume you saved the modified CNN as cnn_modified.py
...
output_dir = '/remote/gpu01a/pietschke/EoRFlow/output/full_EoR_pure_7_384'
