...
# ---------------------------
base_output_dir = '/remote/gpu01a/pietschke/EoRFlow/output/SKA_flow/optuna_study'
...
def objective(trial: optuna.trial.Trial) -> float:
    ...
    n_nodes = trial.suggest_int("n_nodes", 128, 512)
    ...
    model_params = {
        'flow': {
            ...
            'n_blocks': n_blocks,
            'n_nodes': n_nodes,
            'cond_dims': 300,     # Condition dimension; adjust if needed.
            'load': False,
