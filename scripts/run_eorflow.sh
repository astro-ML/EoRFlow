#!/bin/bash
#SBATCH --job-name=train_eorflow # name of job
#SBATCH --output=train_eorflow%j.out # output file (%j = job ID)
#SBATCH --error=train_eorflow%j.err # error file (%j = job ID)
...
srun /linkhome/rech/genpic01/uuv28wh/.conda/envs/ska_env/bin/python train_flow_only.py
