#!/bin/bash
#SBATCH --job-name=train_eorflow       # Job name
...
#SBATCH --output=train_eorflow.o%A    # Standard output
#SBATCH --error=train_eorflow.e%A     # Standard error
...
nice -19 python train_eorflow.py
