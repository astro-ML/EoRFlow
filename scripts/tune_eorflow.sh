#!/bin/bash
#SBATCH --job-name=tune_eorflow # name of job
#SBATCH --output=tune_eorflow%j.out # output file (%j = job ID)
#SBATCH --error=tune_eorflow%j.err # error file (%j = job ID)
...
cd /lustre/fswork/projects/rech/ybg/uuv28wh/EoRFlow/src/training
srun /linkhome/rech/genpic01/uuv28wh/.conda/envs/ska_env/bin/python optuna_flow_weights.py
