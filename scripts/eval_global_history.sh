#!/bin/bash
#SBATCH --job-name=eval_global_history_noise       # Job name
...
#SBATCH --output=eval_global_history_noise.o%A    # Standard output
#SBATCH --error=eval_global_history_noise.e%A     # Standard error
...
#nice -19 python inference_global_history_10params.py
#nice -19 python inference_global_history.py
nice -19 python plot_coverage.py
#nice -19 python plot_tarp.py
